# Проектная работа для Яндекс.Практикум №10: _создание сайта, где пользователь сможет размещать фотографии достопримечательных мест в России_
...
1. добавить isLoading при ожидании ответа от сервера
2. добавить валидацию форм
3. добавить закрытие модальных окон при клике на Esc и мышкой
